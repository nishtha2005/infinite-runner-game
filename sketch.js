...
function setup() {
  ...
  trex = createSprite(displayWidth/2,displayHeight/2,30,60);
  ...
  invisibleGround = createSprite(displayWidth/2,displayHeight-180,400,10);
...
function spawnClouds() {
  ...
  if (frameCount % 60 === 0) {
    var cloud = createSprite(600,120,60,30);
...
function spawnObstacles() {
  if(frameCount % 60 === 0) {
    var obstacle = createSprite(displayWidth,displayHeight/2+160,10,50);
    //obstacle.debug = true;
